...
| Tests | `uv run pytest -q` | PASS | 34 tests passed, covering strict/free validation, proxy guard, resumable free-real downloads, stock panels, target backtests, overlay research, drawdown, and engine rules. |
